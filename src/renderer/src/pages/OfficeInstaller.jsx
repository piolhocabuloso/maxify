...
function ConfirmInstallModal({ open, onClose, onConfirm }) {
    if (!open) return null
    ...
    return createPortal(
        <AnimatePresence>
            ...
            >
                ...
                >
                    <Card className="relative overflow-hidden rounded-[30px] border border-blue-500/25 bg-gradient-to-br from-maxify-card to-maxify-bg p-7 shadow-2xl shadow-blue-500/20">
