...
function App() {
  ...
  useEffect(() => {
    ...
    async function syncFreeSessionWithMain() {
      ...
      try {
        ...
        console.warn("Falha ao sincronizar sessão Free:", result?.error)
        setVerificandoLogin(false)
      } catch (error) {
        console.error("Erro ao sincronizar sessão Free com o main:", error)
        if (mounted) setVerificandoLogin(false)
      }
    }
        ...
        >
          <Suspense fallback={<PageLoading />}>
            <Routes>
              ...
              <Route path="/apps" element={<GuardedPage path="/apps" title="Impulso"><Apps /></GuardedPage>} />
